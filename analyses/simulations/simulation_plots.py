...
def analyze_metrics(csv_path, output_folder='sweep_results_plots'):
    # Read the CSV file
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="simulations/random_sweep_results_plots", 
                        help="Output folder for plots (default: simulations/random_sweep_results_plots)")
    ...
    analyze_metrics(csv_path, args.output)
